...
public class DAO {
    ...
    private static com.example.healthalert.DAO dao = null;
    ...
    public static synchronized com.example.healthalert.DAO getInstance(Context context)
    {
        Log.d(TAG, "getting DAO instance");
        if (dao == null)
        {
            dao = new com.example.healthalert.DAO();
